...
function Designation_Add(props) {
    ...
    const [input_salary, setInput_salary] = useState("");
    ...
    const handleSubmit = async () => {
        try {
            ...
            if(validator_isEmpty(input_name)){
                ...
                let req = await AxiosPost("/designation", token, request);
                ShowSnakBar("success", "New Designation created successfully");
